    ...
    def add_unity_vs_texture_override_ib_sections(self,config_ini_builder:M_IniBuilder,commandlist_ini_builder:M_IniBuilder,draw_ib_model:DrawIBModel):
        ...
        if unique_str:
            for component_model in draw_ib_model._component_model_list:
                ...
                texture_override_ib_section.append("[Resource_IB_" + draw_ib + "_Bak_" + component_index + "]")
                ...
                texture_override_ib_section.append("Resource_IB_" + draw_ib + "_Bak_" + component_index + " = ref ib")
                ...
                if ib_buf is None or len(ib_buf) == 0:
                    ...
                    texture_override_ib_section.append("ib = Resource_IB_" + draw_ib + "_Bak_" + component_index)
